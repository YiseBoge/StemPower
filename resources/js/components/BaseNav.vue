<template>
  ...
  >
    <div class="container">
      ...
      <slot name="brand">
        <a @click.prevent="onTitleClick" class="navbar-brand" href="#">
          {{ title }}
        </a>
      </slot>
      ...
      <div :class="{show: toggled}" :id="contentId" class="collapse navbar-collapse" v-click-outside="closeMenu">
        <div class="navbar-collapse-header">
          <slot :close-menu="closeMenu" name="content-header"/>
        </div>
