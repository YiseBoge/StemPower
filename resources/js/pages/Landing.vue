    ...
    <div>
        ...
        <div class="position-relative">
            ...
            <section class="section-shaped my-0">
                <div class="shape shape-style-2 shape-default shape-skew" style="z-index: 5; background: #ffffff; margin-top: 50%; height: 30%;">
                    
                </div>
                <div class="container-fluid shape-container d-flex mb-5" style="background-image: url('img/theme/Science-Museum-1.jpg'); background-size: cover;">
                    <div class="container" style="margin-top: -5%">
                        <div class="row">
                            <div class="col-lg-6">
                                <h1 class="display-3  text-white">Inside Every Child is a Scientist.</h1>
                                <p class="lead  text-white">Nurture that Scientist, you will change the world.</p>
                        ...
                        <div class="row row-grid justify-content-center">
                            <div class="col-lg-12">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    <h3 class="text-primary text-uppercase text-center">Welcome to STEMPower</h3>
                                    <p class="description mt-3">For more than a decade, STEMpower founders have been implementing many successful STEM programs (Science, Technology, Engineering, and Math) in Ethiopia and nearby countries.

Pre-university students learn through our hands-on labs, engaging them towards advanced STEM study and careers.

STEM enrichment programs bridge genders and ethnicity, fostering peace and development within and among nations.</p>
                                    <div>
                                        <badge type="primary" rounded>science</badge>
                                        <badge type="primary" rounded>technology</badge>
                                        <badge type="primary" rounded>engineering</badge>
                                        <badge type="primary" rounded>math</badge>
                                    </div>
                                </card>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="row row-grid align-items-center">
                    <div class="col-md-6 order-md-2">
                        <img src="img/theme/A-girl-in-the-lab.jpg" class="img-fluid floating">
                    </div>
                    <div class="col-md-6 order-md-1">
                        <div class="pr-md-5">
                            <icon name="ni ni-settings-gear-65" class="mb-5" size="lg" type="success" shadow
                                  rounded></icon>
                            <h3 class="text-primary text-uppercase">Our Vision</h3>
                            <p>Towards a technologically-developed, economically-independent, and self-sustaining Ethiopia-Africa.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <h3 class="text-primary text-uppercase text-center mt-5">Our Mission</h3>
                        ...
                        <div class="row row-grid">
                            <div class="col-lg-4">
                                <card class="border-0 h-100" hover shadow body-classes="py-5">
                                    <img class="m-auto" src="img/icons/01.png" >
                                    <h6 class="text-primary text-uppercase text-center mt-3">Solve Societal Problems</h6>
                                    <p class="description mt-3 text-center">Hands-on lab-based STEM education emphasizes real-world problem-solving, creativity, and skill-building empowering youth to engineer their homeland away from stubborn poverty.</p>
                                    
                                </card>
                            </div>
                            <div class="col-lg-4">
                                <card class="border-0 h-100" hover shadow body-classes="py-5">
                                    <img src="img/icons/02.jpg" style="border-radius: 100px;">
                                    <h6 class="text-success text-uppercase text-center mt-3">Strengthen Nations</h6>
                                    <p class="description mt-3 text-center">Engineering skills complete a country's production value chain leading to more exports, less imports, and reduced dependency.</p>
                                   
                                </card>
                            </div>
                            <div class="col-lg-4">
                                <card class="border-0 h-100" hover shadow body-classes="py-5 h-25">
                                    <img src="img/icons/03.png">
                                    <h6 class="text-warning text-uppercase text-center mt-3">Implement Empowerment</h6>
                                    <p class="description mt-3 text-center">Pre-university STEM enrichment enhances education, competency, innovation, and careers on a national scale that "lifts all boats."</p>
